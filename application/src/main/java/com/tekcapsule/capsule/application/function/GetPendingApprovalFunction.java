...
@Component
@Slf4j
public class GetPendingApprovalFunction implements Function<Message<EmptyFunctionInput>, Message<List<Capsule>>> {

    private final CapsuleService capsuleService;

    private final AppConfig appConfig;

    public GetPendingApprovalFunction(final CapsuleService capsuleService, final AppConfig appConfig) {
    ...
    public Message<List<Capsule>> apply(Message<EmptyFunctionInput> updateInputMessage) {
        ...
        try {
            log.info(String.format("Entering get Pending approval capsules Function"));
            capsules = capsuleService.getPendingApproval();
